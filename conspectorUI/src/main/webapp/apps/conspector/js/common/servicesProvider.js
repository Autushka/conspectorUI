app.factory('servicesProvider', ['$rootScope', '$state', '$translate', 'utilsProvider', '$window', '$filter', '$mdDialog', '$rootScope',
	function($rootScope, $state, $translate, utilsProvider, $window, $filter, $mdDialog, $rootScope) {
		return {
