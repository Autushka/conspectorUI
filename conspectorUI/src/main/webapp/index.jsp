...
<html ng-app="conspector" style="height: 100%;">
	<head>
		...
		<!-- MOBILE JS DEPENDENCIES <script src="bower_components/ngCordova/dist/ng-cordova.js"></script>-->
		
	    <!-- <script type="text/javascript" src="cordova.js"></script>
	    // <script type="text/javascript" src="js/index.js"></script>	-->		
		
		<!-- WEBAPP JS DEPENDENCIES <script src="bower_components/isteven-angular-multiselect/angular-multi-select.js"></script>
		...
		<!-- standard control has been modified to support multiple tables on the view  TODO: dont forget to minify it <script src="apps/conspector/js/thirdParty/angular-file-upload-shim.min.js"></script>  -->
		
		<!-- version 2.0.5 is not available on bower  TODO: try to put it on bower <script src="apps/conspector/js/thirdParty/angular-file-upload.min.js"></script> -->
		
		<!-- version 2.0.5 is not available on bower  TODO: try to put it on bower <script src="apps/conspector/js/thirdParty/jQuery.download.js"></script> -->		
		
		<!-- small function that needed to allow ajax requests that return files (needed for dynamic reports...)-->		
			    			
	    <!-- COMMON JS <script src="apps/conspector/js/constants.js"></script> -->
		...
		<!--WEBAPP CONTROLLERS <script src="apps/conspector/js/common/cacheProvider.js"></script>		
